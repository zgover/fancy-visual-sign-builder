...
<section class="fpd-main-bar fpd-clearfix fpd-primary-bg-color">
	...
	<div class="fpd-left">
		...
		<div class="fpd-btn fpd-primary-text-color" data-context="adds">
			<i class="fpd-icon-add"></i><span>Add Text or Design</span>
		</div>
		<div class="fpd-btn fpd-primary-text-color" data-context="products">
			<i class="fpd-icon-product"></i><span>Change Sign Shape</span>
		</div>
	</div>
				...
				<div class="fpd-list">
					...
					<div class="fpd-helper-btns fpd-list-row">
						<div class="fpd-cell-full">
							<div>
								<span>
									<span title="<?php echo $center_h; ?>" class="fpd-center-horizontal fpd-btn fpd-tooltip"><i class="fpd-icon-align-horizontal"></i></span>
									<span title="<?php echo $center_v; ?>" class="fpd-center-vertical fpd-btn fpd-tooltip"><i class="fpd-icon-align-vertical"></i></span>
								</span>
								<!-- <span>
									<span title="<?php echo $flip_horizontal; ?>" class="fpd-flip-horizontal fpd-btn fpd-tooltip"><i class="fpd-icon-flip-horizontal"></i></span>
									<span title="<?php echo $flip_vertical; ?>" class="fpd-flip-vertical fpd-btn fpd-tooltip"><i class="fpd-icon-flip-vertical "></i></span>
								</span> -->
								<!-- <span title="<?php echo $reset_element; ?>" class="fpd-reset-element fpd-btn fpd-tooltip"><i class="fpd-icon-reset"></i></span> -->
							</div>
						</div>
					</div>
