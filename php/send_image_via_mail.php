...
$to = 	$_ENV['EMAIL_SHARE_RECIPIENT'];//set here your receiving mail address
$subject = 	$_ENV['EMAIL_SHARE_SUBJECT']; //set here the mail subject
$bound_text = 	md5(date('r', time()));
$bound = 	"--".$bound_text."\r\n";
$bound_last = 	"--".$bound_text."--\r\n";

$headers = 	"From: " . $_ENV['EMAIL_SHARE_SENDER'] . "\r\n";//set here the sending mail address
...
$message .= 	"Content-Type: text/html; charset=\"iso-8859-1\"\r\n"
  	...
  	.$_ENV['EMAIL_SHARE_INITIAL_MESSAGE']."\r\n" //set here the mail text
  	.$bound;
